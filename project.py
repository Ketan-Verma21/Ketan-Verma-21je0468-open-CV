 #Project 
import numpy as np , cv2 , matplotlib.pyplot as mlt , cv2.aruco as aruco ,math   #importing essential libraries
...
def rotate_img(img,angle,rotpoint):
    ...
    rotmat=cv2.getRotationMatrix2D(rotpoint,angle,1.0)#to make the transformation matrix M which will be used for rotating a image
...
def augmenting(corners,ids,img,imgaug):
    ...
    imgout=cv2.warpPerspective(imgaug,matrix,(img.shape[1],img.shape[0])) #used to paste on image to another 
...
img1=cv2.imread("C:\\Users\\Ketan Kumar Verma\\OneDrive\\Desktop\\robo ism\\3.jpg")
img2=cv2.imread("C:\\Users\\Ketan Kumar Verma\\OneDrive\\Desktop\\robo ism\\4.jpg")
img3=cv2.imread("C:\\Users\\Ketan Kumar Verma\\OneDrive\\Desktop\\robo ism\\1.jpg")
img4=cv2.imread("C:\\Users\\Ketan Kumar Verma\\OneDrive\\Desktop\\robo ism\\2.jpg")
d=[]
d.append(img1)
d.append(img2)
d.append(img3)
...
#calling all the functions and giving argments to them
for i in d:
